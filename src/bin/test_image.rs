...
async fn main() -> anyhow::Result<()> {
    ...
    match client.generate_image("A cute robot holding a flower, high quality", &piotr::config::ModelSettings { name: "imagen-4.0-generate-001".to_string(), ..Default::default() }).await {
